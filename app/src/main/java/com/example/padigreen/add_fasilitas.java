...
public class add_fasilitas extends AppCompatActivity {

    com.rengwuxian.materialedittext.MaterialEditText ETNama_fasilitas,ETJumlah, ETStatus;
    String nama_fasilitas,jumlah,status;
    Button BTNSubmit;
        ...
        BTNImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitMap != null) {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(add_fasilitas.this);
...
//                id = ETId.getText().toString();
                nama_fasilitas     = ETNama_fasilitas.getText().toString();
                ...
                alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        if (bitMap == null){
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(add_fasilitas.this);
    ...
    void validasiData(){
        if(nama_fasilitas.equals("") ||jumlah.equals("") || status.equals("")){
            progressDialog.dismiss();
            Toast.makeText(add_fasilitas.this, "Periksa kembali data yang anda masukkan !", Toast.LENGTH_SHORT).show();
        }else {
            kirimData();
        }
    }
        ...
        builder.setItems(rPilihan, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (pilihan.equals("Take a photo"))
                {
                    ...
                    Uri fileProvider = FileProvider.getUriForFile(add_fasilitas.this, authorities, photoFile);
                ...
                else
                {
                    ...
                    ActivityCompat.requestPermissions(add_fasilitas.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, CODE_GALLERY_REQUEST);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(add_fasilitas.this, "Picture wasn't taken!", Toast.LENGTH_SHORT).show();
            }
        } else {
            if (intent != null) {
    ...
    void kirimData(){
        ...
        AndroidNetworking.post("https://tkjbpnup.com/kelompok_3/api/addMahasiswa.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(add_fasilitas.this, ""+pesan, Toast.LENGTH_SHORT).show();
                            Log.d("status",""+status);
                            if(status){
                                new AlertDialog.Builder(add_fasilitas.this)
                                        .setMessage("Berhasil Menambahkan Data !")
                                        .setCancelable(false)
                                        .setPositiveButton("Kembali", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent i = new Intent(add_fasilitas.this, fasilitas.class);
                                                startActivity(i);
                                            }
                                        })
                                        .show();
